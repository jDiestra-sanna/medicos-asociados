...
<div class="row">
    <div class="col-7">
        <div class="row" id="divbuscapaciente">
            <div class="col-11">
        ...
        jQuery('#ate_busca_paciente_id').on('change', function (data) {
            ...
            jQuery.ajax({
                ...
                success: function (response) {
                    ...
                    if(datospaciente){
                        debugger;
                        $('#ate_ape_paterno').val(datospaciente.appat_pac);
                        $('#ate_ape_materno').val(datospaciente.apmat_pac);
                        $('#ate_nombres').val(datospaciente.nom_pac);
                        $('#ate_sexo').val(datospaciente.sex_pac?1:0);
                        $('#ate_nro_documento').val(datospaciente.num_doc_id);
                        $('#ate_tipo_documento').val(datospaciente.id_doc_id);
                        $('#ate_email').val(datospaciente.correo_pac);
                        $('#ate_fecha_nacimiento').val(datospaciente.fnac_pac);
                        $('#ate_edad').val(datospaciente.edad.y);
                        ...
                        tablaH.DataTable({
                            ...
                            data: datospaciente.direcciones,
                            select: true,
                            searching: false,
                            sorting: false,
                            bInfo : false,
